...
insert into u1 select token from uuid_tab;
insert into u2 select token from uuid_tab offset 400000 limit 200000;

insert into s1 select token::string from uuid_tab;
insert into s2 select token::string from uuid_tab offset 400000 limit 200000;
